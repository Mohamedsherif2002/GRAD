...
def build_CFRF_Model(dataset, args):
    ...
    if hasattr(args, 'tfidf'):
        if args.dataset == 'GQA':
            w_emb = tfidf_loading(args.tfidf, w_emb, args, '../gqa')
            sw_emb = tfidf_loading(args.tfidf, sw_emb, args, '../gqa')
            ew_emb = tfidf_loading(args.tfidf, ew_emb, args, '../gqa')

        elif args.dataset == 'VQA':
            w_emb = tfidf_loading(args.tfidf, w_emb, args, '../vqa')
            sw_emb = tfidf_loading(args.tfidf, sw_emb, args, '../vqa')
            ew_emb = tfidf_loading(args.tfidf, ew_emb, args, '../vqa')
